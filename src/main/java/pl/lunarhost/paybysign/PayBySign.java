 ...
 */
public class PayBySign {
    static final Logger logger = Logger.getLogger(PayBySign.class.getName());

    protected static final String NAMESPACE = "[PayBySign]";
    ...
    public PayBySign(Sign sign, String playerName, double price, int delay) {
